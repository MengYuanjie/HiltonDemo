...
export const fetchReservation =(id) => API.get(`/reservations/${id}`)
export const addReservation =( reservation ) => API.post('/reservations', reservation)
export const updateReservation = (id, updatedReservation) => API.patch(`/reservations/${id}`, updatedReservation)
export const deleteReservation =(id) => API.delete(`/reservations/${id}`)
export const fetchReservationsByUser = (searchQuery) => API.get(`/reservations?searchQuery=${searchQuery.search}`);
