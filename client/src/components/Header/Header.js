...
const Header = () => {
  ...
  if (!user) return (
    <div className={styles.header2}>
      <img style={{ width: '50px', cursor: 'pointer' }} onClick={() => history.push('/')} src="https://blog.logo123.com/wp-content/uploads/2017/07/0727.jpg" alt="arc" />
                ...
                <Paper elevation={3}>
                  <ClickAwayListener onClickAway={handleClose}>
                    <MenuList autoFocusItem={open} id="menu-list-grow" onKeyDown={handleListKeyDown} >
                      <MenuItem >{(user?.result?.name).split(" ")[0]}</MenuItem>
