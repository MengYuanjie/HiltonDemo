...
const initialState = { firstName: '', lastName: '', email: '', password: '', confirmPassword: '', profilePicture: '', bio: '', role: 'admin' }
            ...
            {isSignup && (
              <>
                ...
                <div style={{ padding: '10px' }}>
                  <Typography component="h1" variant="h6">Role</Typography>
                  <Select name="role" label="Role" type="role" onChange={handleChange} defaultValue={'admin'} className='signup_role'>
