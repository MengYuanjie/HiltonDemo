            ...
            .then(user => {
                ...
                user.save().then((result) => {
                    transporter.sendMail({
                        to: user.email,
                        from: "test<hello@test.com>",
                        subject: "Password reset request",
                        html: `
                    <p>You requested for password reset from  application</p>
                    <h5>Please click this <a href="https://test.com/reset/${token}">link</a> to reset your password</h5>
